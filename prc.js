// <!-- jquery prac -->
    ...
    // $('#ta').val('setting it to hamna');
    // $('#ta').html('setting it to hamna');
    // $('#ta').html('setting it to hamna3');
    // $('#inp').html('setting it to hamna3');
    // $('#inp').val('setting it to hamna3');
    // $('#inp').empty()
    // $('#wiki').empty()
